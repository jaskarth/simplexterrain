...
import net.fabricmc.fabric.api.levelgenerator.v1.CreateLevelGenerator;
import net.fabricmc.fabric.api.world.gen.FabricChunkGeneratorType;
...
public class SimplexTerrain implements ModInitializer {
	...
	public void onInitialize() {
		...
		SIMPLEX_LEVELGEN = CreateLevelGenerator.create(name, SIMPLEX_CHUNKGEN, (world ->
